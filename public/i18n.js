...
'rd.cGuardadas':'Matérias guardadas','rd.cSetor':'Do setor mineral','rd.cGoias':'Citam Goiás','rd.cGoiasSetor':'Goiás e setor','rd.todosMunicipios':'Todos os municípios',
...
'rd.acervo':'A lista abre nas mais relevantes. Escolha um mês para trazer o resto do acervo, ou um município para ver só o que fala dele.','rd.newsUma':'1 matéria neste recorte.','rd.newsMostrando':'{mostradas} matérias neste recorte.','rd.newsParcial':'Mostrando as {mostradas} primeiras de {filtradas}. Use os filtros para reduzir.','rd.buscaPh':'Buscar no título','rd.todasSubstancias':'Todas as substâncias','rd.soSetor':'Só mineração','rd.soGoias':'Só Goiás','rd.semFiltro':'Nenhuma matéria com esses filtros.','rd.viaBusca':'via busca','rd.s.terras_raras':'terras raras','rd.s.litio':'lítio','rd.s.ouro':'ouro','rd.s.niquel':'níquel','rd.s.niobio':'nióbio','rd.s.cobre':'cobre','rd.s.uranio':'urânio','rd.s.fosfato':'fosfato','rd.s.energia_eletrica':'energia elétrica','rd.s.gas_natural':'gás natural',
...
'rd.cGuardadas':'Stories kept','rd.cSetor':'About mining','rd.cGoias':'Mention Goiás','rd.cGoiasSetor':'Goiás and mining','rd.todosMunicipios':'All municipalities',
