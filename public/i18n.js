...
'pn.noMineral':"Sem mineral",'pn.empNi':"Titular não identificado",'pn.empHidden':"Pessoa física ou sem CNPJ (nome oculto)",'pn.pf':"Pessoa física (nome oculto)",
'pn.others':"Outros",'pn.empty':"Sem dados neste recorte.",'pn.noRecord':"sem registro",'pn.from':"a partir de",
'pn.showAll':"Mostrar todos ({n})",'pn.showLess':"Mostrar menos",'pn.u.bi':"bi",'pn.u.mi':"mi",
'pn.u.k':"mil",'pn.refYear':"Ano de referência: {y} (último ano do recorte com dado).",'pn.decade':"anos {d}",'pn.noAtlas':"O retrato do atlas não carregou; este quadro depende dele.",
'pn.mapMetric':"Indicador",'pn.map.cfem':"CFEM recolhida (R$)",'pn.map.proc':"Processos minerários",'pn.map.area':"Área dos processos (ha)",
'pn.map.ee':"Consumo nas parcelas de carga da CCEE (GWh)",'pn.mapHint':"Clique num município para usá-lo como filtro.",'pn.invShareMin':"A participação no Brasil só é calculada sem filtro de mineral: o arquivo nacional é somado por ano e gasto.",'pn.lavraPagou.sim':"Detém lavra e recolheu CFEM em 2022–2026",
'pn.lavraPagou.nao':"Detém lavra e não recolheu CFEM",'pn.lv.0':"Alta",'pn.lv.1':"Média",'pn.lv.2':"Baixa",
'pn.rub.analise_fisica':"Análise física",'pn.rub.analise_quimica':"Análise química",'pn.rub.ensaio_beneficiamento':"Ensaio de beneficiamento",'pn.rub.galeria_shaft':"Galeria e shaft",
'pn.rub.geologia':"Geologia",'pn.rub.infraestrutura':"Infraestrutura",'pn.rub.outro':"Outros gastos",'pn.rub.geofisica':"Prospecção geofísica",
'pn.rub.geoquimica':"Prospecção geoquímica",'pn.rub.sondagem':"Sondagem",'pn.rub.topografia':"Topografia, cartografia e desenho",'pn.rub.trincheira_poco':"Trincheira e poço",
'pn.s.resumo':"O estado em cinco medidas",'pn.s.resumo.lead':"Arrecadação, valor produzido, território titulado, pesquisa e energia no recorte escolhido.",'pn.s.cfem':"Quanto Goiás arrecada de CFEM",'pn.s.cfem.lead':"O royalty da mineração recolhido em Goiás, de janeiro de 2022 ao início de agosto de 2026.",
...
'pn.s.nr':"O que não foi refeito",'pn.s.nr.lead':"Quadros do Panorama original que dependem de fontes que não estão nas bases do repositório.",'pn.k.cfem':"CFEM recolhida",'pn.k.cfemSub':"Período {p}",
'pn.k.benef':"Valor da produção beneficiada",'pn.k.benefSub':"Anuário Mineral Brasileiro, {y}",'pn.k.proc':"Processos minerários ativos",'pn.k.procSub':"{ha} ha em {m} municípios",
'pn.k.inv':"Investimento em pesquisa",'pn.k.invSub':"Declarado à ANM, {p}",'pn.k.ee':"Consumo nas parcelas da CCEE",'pn.k.eeSub':"Período {p}",
'pn.k.producers':"Titulares que recolheram CFEM",'pn.k.producersSub':"Período {p}",'pn.k.top5':"Fatia dos 5 maiores na CFEM",'pn.k.top10':"Os 10 maiores somam {v}%",
'pn.k.lavra':"Titulares com título de lavra",'pn.k.lavraSub':"{n} títulos que autorizam produção",'pn.k.pesq':"Titulares com alvará de pesquisa",'pn.k.pesqSub':"{n} alvarás",
'pn.k.eeTotal':"Consumo total das parcelas",'pn.k.eeTotalSub':"CCEE, {p}",'pn.k.eeAcl':"Mercado livre (ACL)",'pn.k.eeAclSub':"{v}% do total; {c} GWh na parte cativa",
'pn.k.eeMin':"Cadeia mineral",'pn.k.eeMinSub':"{v}% do consumo (extração, minerais não metálicos e metalurgia)",'pn.k.eeEmp':"Empresas com carga",'pn.k.eeEmpSub':"{n} com título minerário na base",
'pn.h.mun':"Município",'pn.h.cfem':"CFEM",'pn.h.acum':"% acum.",'pn.h.proc':"Processos",
'pn.h.area':"Área (ha)",'pn.h.pctArea':"% da área",'pn.h.shareGo':"Participação de Goiás",'pn.h.min':"Mineral",
'pn.h.rom':"Produção bruta (t)",'pn.h.benefT':"Beneficiada (t)",'pn.h.benefRs':"Valor da beneficiada",'pn.h.contRom':"Contido na bruta (t)",
'pn.h.contBenef':"Contido na beneficiada (t)",'pn.h.fase':"Fase",'pn.h.invest':"Investimento",'pn.h.year':"Ano",
'pn.h.rsT':"R$ por tonelada",'pn.h.sit':"Situação",'pn.h.areas':"Áreas",'pn.h.lances':"Lances vencedores",
'pn.h.rodada':"Rodada",'pn.h.processo':"Processo",'pn.h.lance':"Lance",'pn.h.venc':"Arrematante",
'pn.h.emp':"Empresa ou titular",'pn.h.cnpj':"CNPJ (raiz)",'pn.h.mins':"Principais minerais",'pn.h.muns':"Municípios",
'pn.h.leader':"Líder",'pn.h.leaderShare':"Fatia do líder",'pn.h.mod':"Modalidade",'pn.h.titles':"Títulos",
'pn.h.holders':"Titulares",'pn.h.holder':"Titular",'pn.h.mod0':"Concessão",'pn.h.mod1':"Licenc.",
'pn.h.mod2':"Garimp.",'pn.h.mod3':"Registro",'pn.h.alvaras':"Alvarás",'pn.h.acl':"Mercado livre (MWh)",
'pn.h.cativo':"Parte cativa (MWh)",'pn.h.mwh':"Consumo (MWh)",'pn.h.livrePct':"% livre",'pn.h.months':"Meses",
'pn.h.emps':"Empresas",'pn.h.ramo':"Ramo",'pn.h.mw':"Capacidade média (MW)",'pn.h.fc':"Fator de carga",
'pn.h.rsMwh':"CFEM por MWh",'pn.h.class':"Classe",'pn.h.gwh':"Energia (GWh)",'pn.h.massa':"Massa (t)",
'pn.h.coef':"Coeficiente",'pn.h.mainSub':"Principal substância",'pn.h.dam':"Barragem",'pn.h.ore':"Minério",
'pn.h.risk':"Risco (CRI)",'pn.h.damage':"Dano (DPA)",'pn.h.operation':"Situação",'pn.h.emergency':"Emergência",
'pn.h.coords':"Coordenadas",'pn.h.riskDamage':"Risco × dano",'pn.h.total':"Total",'pn.c.tiles':"Resumo do recorte",
'pn.c.tiles.n':"Cada número usa só os filtros que se aplicam à sua fonte.",'pn.c.cfem_ano':"CFEM arrecadada em Goiás, por ano",'pn.c.cfem_ano.n':"R$ recolhidos (aba 08). 2026 vai até o início de agosto e aparece mais claro.",'pn.c.cfem_janjul':"CFEM de janeiro a julho",
...
'pn.tabsAria':"Categorias de análise",'pn.filterNotUsed':"Nenhum quadro desta aba usa este filtro.",'pn.tab.resumo':"Visão geral",'pn.tab.arrecadacao':"Arrecadação (CFEM)",'pn.tab.territorio':"Território",'pn.tab.producao':"Produção",'pn.tab.pesquisa':"Pesquisa e direitos",'pn.tab.empresas':"Empresas",'pn.tab.energia':"Energia",'pn.tab.barragens':"Barragens",'pn.tab.notas':"Notas"
},en:{
...
'pn.noMineral':"No mineral",'pn.empNi':"Unidentified holder",'pn.empHidden':"Individual or no CNPJ (name hidden)",'pn.pf':"Individual (name hidden)",
'pn.others':"Others",'pn.empty':"No data in this cut.",'pn.noRecord':"no record",'pn.from':"from",
'pn.showAll':"Show all ({n})",'pn.showLess':"Show less",'pn.u.bi':"bn",'pn.u.mi':"M",
'pn.u.k':"k",'pn.refYear':"Reference year: {y} (latest year with data in the cut).",'pn.decade':"{d}s",'pn.noAtlas':"The atlas snapshot did not load; this panel depends on it.",
'pn.mapMetric':"Indicator",'pn.map.cfem':"CFEM collected (R$)",'pn.map.proc':"Mining claims",'pn.map.area':"Claim area (ha)",
'pn.map.ee':"Consumption of CCEE load units (GWh)",'pn.mapHint':"Click a municipality to use it as a filter.",'pn.invShareMin':"The share of Brazil is only computed without a mineral filter: the national file is summed by year and spending type.",'pn.lavraPagou.sim':"Holds mining titles and paid CFEM in 2022–2026",
'pn.lavraPagou.nao':"Holds mining titles and paid no CFEM",'pn.lv.0':"High",'pn.lv.1':"Medium",'pn.lv.2':"Low",
'pn.rub.analise_fisica':"Physical analysis",'pn.rub.analise_quimica':"Chemical analysis",'pn.rub.ensaio_beneficiamento':"Processing tests",'pn.rub.galeria_shaft':"Galleries and shafts",
'pn.rub.geologia':"Geology",'pn.rub.infraestrutura':"Infrastructure",'pn.rub.outro':"Other spending",'pn.rub.geofisica':"Geophysical prospecting",
'pn.rub.geoquimica':"Geochemical prospecting",'pn.rub.sondagem':"Drilling",'pn.rub.topografia':"Surveying, mapping and drafting",'pn.rub.trincheira_poco':"Trenches and pits",
'pn.s.resumo':"The state in five measures",'pn.s.resumo.lead':"Royalties, production value, titled territory, research and energy in the chosen cut.",'pn.s.cfem':"How much CFEM Goiás collects",'pn.s.cfem.lead':"The mining royalty collected in Goiás, from January 2022 to early August 2026.",
...
'pn.s.nr':"What was not rebuilt",'pn.s.nr.lead':"Panels of the original Panorama that depend on sources not present in the repository bases.",'pn.k.cfem':"CFEM collected",'pn.k.cfemSub':"Period {p}",
'pn.k.benef':"Value of beneficiated production",'pn.k.benefSub':"Brazilian Mineral Yearbook, {y}",'pn.k.proc':"Active mining claims",'pn.k.procSub':"{ha} ha in {m} municipalities",
'pn.k.inv':"Research investment",'pn.k.invSub':"Declared to ANM, {p}",'pn.k.ee':"Consumption of CCEE load units",'pn.k.eeSub':"Period {p}",
'pn.k.producers':"Holders that paid CFEM",'pn.k.producersSub':"Period {p}",'pn.k.top5':"Top 5 share of CFEM",'pn.k.top10':"The top 10 add up to {v}%",
'pn.k.lavra':"Holders of mining titles",'pn.k.lavraSub':"{n} titles that authorise production",'pn.k.pesq':"Holders of research permits",'pn.k.pesqSub':"{n} permits",
'pn.k.eeTotal':"Total consumption of load units",'pn.k.eeTotalSub':"CCEE, {p}",'pn.k.eeAcl':"Free market (ACL)",'pn.k.eeAclSub':"{v}% of the total; {c} GWh in the captive part",
'pn.k.eeMin':"Mineral chain",'pn.k.eeMinSub':"{v}% of consumption (extraction, non-metallic minerals and metallurgy)",'pn.k.eeEmp':"Companies with load",'pn.k.eeEmpSub':"{n} with a mining title in the base",
'pn.h.mun':"Municipality",'pn.h.cfem':"CFEM",'pn.h.acum':"Cum. %",'pn.h.proc':"Claims",
'pn.h.area':"Area (ha)",'pn.h.pctArea':"% of area",'pn.h.shareGo':"Goiás share",'pn.h.min':"Mineral",
'pn.h.rom':"Run-of-mine (t)",'pn.h.benefT':"Beneficiated (t)",'pn.h.benefRs':"Beneficiated value",'pn.h.contRom':"Content in ROM (t)",
'pn.h.contBenef':"Content in beneficiated (t)",'pn.h.fase':"Phase",'pn.h.invest':"Investment",'pn.h.year':"Year",
'pn.h.rsT':"R$ per tonne",'pn.h.sit':"Status",'pn.h.areas':"Areas",'pn.h.lances':"Winning bids",
'pn.h.rodada':"Round",'pn.h.processo':"Claim",'pn.h.lance':"Bid",'pn.h.venc':"Winner",
'pn.h.emp':"Company or holder",'pn.h.cnpj':"CNPJ (root)",'pn.h.mins':"Main minerals",'pn.h.muns':"Municipalities",
'pn.h.leader':"Leader",'pn.h.leaderShare':"Leader share",'pn.h.mod':"Modality",'pn.h.titles':"Titles",
'pn.h.holders':"Holders",'pn.h.holder':"Holder",'pn.h.mod0':"Concession",'pn.h.mod1':"Licensing",
'pn.h.mod2':"Artisanal",'pn.h.mod3':"Registry",'pn.h.alvaras':"Permits",'pn.h.acl':"Free market (MWh)",
'pn.h.cativo':"Captive part (MWh)",'pn.h.mwh':"Consumption (MWh)",'pn.h.livrePct':"% free",'pn.h.months':"Months",
'pn.h.emps':"Companies",'pn.h.ramo':"Sector",'pn.h.mw':"Average capacity (MW)",'pn.h.fc':"Load factor",
'pn.h.rsMwh':"CFEM per MWh",'pn.h.class':"Class",'pn.h.gwh':"Energy (GWh)",'pn.h.massa':"Mass (t)",
'pn.h.coef':"Coefficient",'pn.h.mainSub':"Main substance",'pn.h.dam':"Dam",'pn.h.ore':"Ore",
'pn.h.risk':"Risk (CRI)",'pn.h.damage':"Damage (DPA)",'pn.h.operation':"Status",'pn.h.emergency':"Emergency",
'pn.h.coords':"Coordinates",'pn.h.riskDamage':"Risk × damage",'pn.h.total':"Total",'pn.c.tiles':"Summary of the cut",
'pn.c.tiles.n':"Each figure only uses the filters that apply to its source.",'pn.c.cfem_ano':"CFEM collected in Goiás, by year",'pn.c.cfem_ano.n':"R$ collected (sheet 08). 2026 runs to early August and is drawn lighter.",'pn.c.cfem_janjul':"CFEM from January to July",
...
'pn.nr.inativos.why':"The base SIGMINE only has active claims; the decade of filing is shown for them only.",'pn.nr.coef_empresas':"Coefficients by operation and production declared by companies.",'pn.nr.coef_empresas.why':"They depend on company reports; pairing CCEE with operations belongs to Student 3.",
'pn.tabsAria':"Analysis categories",'pn.filterNotUsed':"No panel in this tab uses this filter.",'pn.tab.resumo':"Overview",'pn.tab.arrecadacao':"Royalties (CFEM)",'pn.tab.territorio':"Territory",'pn.tab.producao':"Production",'pn.tab.pesquisa':"Research and rights",'pn.tab.empresas':"Companies",'pn.tab.energia':"Energy",'pn.tab.barragens':"Dams",'pn.tab.notas':"Notes"
}};
function pick(){
