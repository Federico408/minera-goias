...
'rd.cGuardadas':'Matérias do setor','rd.cSubstancias':'Substâncias citadas','rd.cVeiculos':'Veículos citados','rd.cGoias':'Citam Goiás','rd.todosMunicipios':'Todos os municípios',
'rd.todosMeses':'Todos os meses','rd.anteriores':'Antes disso','rd.carregandoMes':'Buscando o mês…','rd.mesFalhou':'Não foi possível carregar {mes}.','rd.acervoMeses':'{total} matérias guardadas em {meses} arquivos de mês.',
'rd.acervo':'Só entra aqui notícia do setor mineral: o que os veículos publicam fora disso não é guardado. A lista abre nas mais relevantes — escolha um mês para trazer o resto, ou um município para ver só o que fala dele.','rd.newsUma':'1 matéria neste recorte.','rd.newsMostrando':'{mostradas} matérias neste recorte.','rd.newsParcial':'Mostrando as {mostradas} primeiras de {filtradas}. Use os filtros para reduzir.','rd.buscaPh':'Buscar no título','rd.todasSubstancias':'Todas as substâncias','rd.soGoias':'Só Goiás','rd.semFiltro':'Nenhuma matéria com esses filtros.','rd.viaBusca':'via busca','rd.s.terras_raras':'terras raras','rd.s.litio':'lítio','rd.s.ouro':'ouro','rd.s.niquel':'níquel','rd.s.niobio':'nióbio','rd.s.cobre':'cobre','rd.s.uranio':'urânio','rd.s.fosfato':'fosfato','rd.s.energia_eletrica':'energia elétrica','rd.s.gas_natural':'gás natural',
'rd.noticias':'Últimas notícias','rd.regional':'GOIÁS','rd.contagem':'{regionais} de {total} matérias citam Goiás ou um município minerador do estado.','rd.noticiasSub':'Mineração e energia, coletadas diariamente',
...
'rd.cGuardadas':'Mining stories','rd.cSubstancias':'Substances mentioned','rd.cVeiculos':'Outlets cited','rd.cGoias':'Mention Goiás','rd.todosMunicipios':'All municipalities',
'rd.todosMeses':'All months','rd.anteriores':'Earlier','rd.carregandoMes':'Fetching the month…','rd.mesFalhou':'Could not load {mes}.','rd.acervoMeses':'{total} stories kept across {meses} monthly files.',
'rd.acervo':'Only mining stories are kept here: whatever else these outlets publish is discarded. The list opens on the most relevant ones — pick a month to fetch the rest, or a municipality to see only what mentions it.','rd.newsUma':'1 story in this selection.','rd.newsMostrando':'{mostradas} stories in this selection.','rd.newsParcial':'Showing the first {mostradas} of {filtradas}. Narrow it with the filters.','rd.buscaPh':'Search the headline','rd.todasSubstancias':'All substances','rd.soGoias':'Goiás only','rd.semFiltro':'No story matches these filters.','rd.viaBusca':'via search','rd.s.terras_raras':'rare earths','rd.s.litio':'lithium','rd.s.ouro':'gold','rd.s.niquel':'nickel','rd.s.niobio':'niobium','rd.s.cobre':'copper','rd.s.uranio':'uranium','rd.s.fosfato':'phosphate','rd.s.energia_eletrica':'electricity','rd.s.gas_natural':'natural gas',
'rd.noticias':'Latest news','rd.regional':'GOIÁS','rd.contagem':'{regionais} of {total} stories mention Goiás or one of its mining municipalities.','rd.noticiasSub':'Mining and energy, collected daily',
