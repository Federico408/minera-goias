...
'rd.acervo':'{total} stories kept · {regionais} mention Goiás · {setoriais} are both about Goiás and about mining. The list opens on the most relevant ones; pick a month to fetch the rest.','rd.newsMostrando':'Showing {mostradas} of {total}.','rd.newsParcial':'Showing {mostradas} of the {filtradas} matches, out of {total} loaded. Narrow it with the filters.','rd.buscaPh':'Search the headline','rd.todasSubstancias':'All substances','rd.soSetor':'Mining only','rd.soGoias':'Goiás only','rd.semFiltro':'No story matches these filters.','rd.viaBusca':'via search','rd.s.terras_raras':'rare earths','rd.s.litio':'lithium','rd.s.ouro':'gold','rd.s.niquel':'nickel','rd.s.niobio':'niobium','rd.s.cobre':'copper','rd.s.uranio':'uranium','rd.s.fosfato':'phosphate','rd.s.energia_eletrica':'electricity','rd.s.gas_natural':'natural gas',
