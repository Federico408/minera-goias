...
'pn.s.intens.lead':"Coeficientes por município do retrato do atlas: energia de 2025 dividida pela produção e pela CFEM.",'pn.c.cfem_sazonal':"Sazonalidade da CFEM",'pn.c.cfem_sazonal.n':"Média de cada mês nos anos completos do recorte (2026 fica de fora por ser parcial).",
...
'pn.c.ee_rs_mwh.n':"Empresas com pelo menos 1 GWh no recorte: CFEM recolhida ÷ energia das suas cargas.",'pn.c.ee_kwh_t':"kWh por tonelada nos municípios comparáveis",'pn.c.ee_kwh_t.n':"Energia de 2025 ÷ massa produzida, só onde a comparação é válida (classe comparável do atlas).",
...
'pn.s.intens.lead':"Municipal coefficients from the atlas snapshot: 2025 energy divided by production and by CFEM.",'pn.c.cfem_sazonal':"CFEM seasonality",'pn.c.cfem_sazonal.n':"Average of each month over the full years of the cut (2026 is left out as partial).",
...
'pn.c.ee_rs_mwh.n':"Companies with at least 1 GWh in the cut: CFEM paid ÷ energy of their loads.",'pn.c.ee_kwh_t':"kWh per tonne in comparable municipalities",'pn.c.ee_kwh_t.n':"2025 energy ÷ mass produced, only where the comparison holds (atlas comparable class).",
