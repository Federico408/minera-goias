...
_malha = gpd.read_file(f"zip://{BASE}/dados/IBGE/GO_Municipios_2025.zip!GO_Municipios_2025.shp")
...
# ---------------------------------------------------------------------------
pop = json.load(open(f"{BASE}/dados/IBGE/populacao_municipal_goias_ultimo_ano.json", encoding="utf-8"))[1:]
pib = json.load(open(f"{BASE}/dados/IBGE/pib_municipal_goias_ultimo_ano.json", encoding="utf-8"))[1:]
pop_by_mun = {}
for r in pop:
