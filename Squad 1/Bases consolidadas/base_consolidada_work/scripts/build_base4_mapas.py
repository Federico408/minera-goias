...
# ---------------------------------------------------------------------------
mun = gpd.read_file("zip://" + arquivo("dados/IBGE/GO_Municipios_2025.zip") + "!GO_Municipios_2025.shp")
...
# ---------------------------------------------------------------------------
sig = gpd.read_file("zip://" + arquivo("dados/ANM/sigmine/GO.zip") + "!GO.shp")
...
for projeto, zp, inner in FONTES_GQ:
    pts = gpd.read_file("zip://" + arquivo(zp) + "!" + inner)
    ...
    n_dup = n_virg = 0
    with zipfile.ZipFile(arquivo(zp)) as z:
